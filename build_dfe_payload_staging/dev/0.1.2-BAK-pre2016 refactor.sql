...
DECLARE @VERSION nvarchar(32) = N'0.1.2';
 ...
 ;WITH RawPayloads AS (
    ...
    OUTER APPLY (
        ...
        /* Option B, STRING_AGG, SQL Server 2022+
          ...
          Notes:
          - Performance impropvements, this the default for anyone on 2022+
          - WITHIN GROUP (ORDER BY ...) requires SQL Server 2022 or Azure SQL
