...
# Add all semantic relationships, using optional custom label if available
for rel in relationships:
    subj = rel.get("subject")
    obj = rel.get("object")
    pred = rel.get("predicate")
    custom_label = rel.get("label", pred)  # Fall back to predicate
    if subj and obj and pred:
        G.add_edge(subj, obj, label=custom_label)
